...
#From the navigation pane of the IDE, choose the .py file that you created in the previous Creating your Python exercise file section. Copy the following code and paste it in the file:
"""
...
def encryptMessage(message, cipherKey, alphabet):
    ...
    for currentCharacter in uppercaseMessage:
        ...
        #le faltaba el INT al CipherKey
